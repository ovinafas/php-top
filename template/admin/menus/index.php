            ...
            <tbody>
               ...
               <!--
                <tr>
                    ...
                    <td>1</td>
                    <td>
                        <a role="button" class="btn btn-sm btn-primary text-white" href="http://localhost/admin-panel/menu/edit/1">edit</a>
                        <a role="button" class="btn btn-sm btn-danger text-white" href="http://localhost/admin-panel/menu/delete/1">delete</a>
                    </td>
                </tr>
-->
            </tbody>
